...
<template>
  ...
  >
    ...
    <div class="mv-detail-widget">
      ...
      <p>
        <i class="iconfont icon-wodeshoucang_l" /><span>{{
          mvInfo.subCount
        }}</span>
      </p>
      <p>
        <router-link :to="`/comment/mv/${mvInfo.id}`">
          <i class="iconfont icon-liuyan" /><span>{{
            mvInfo.commentCount
          }}</span>
        </router-link>
      </p>
      <p>
        <i class="iconfont icon-fenxiang" /><span>{{ mvInfo.shareCount }}</span>
      </p>
    </div>
