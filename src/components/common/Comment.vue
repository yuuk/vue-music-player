      ...
      <header class="clearfix">
        ...
        <div class="userinfo">
          <p class="nickname">
            ...
            <time class="time">{{ comment.time | formatTime }}</time>
          </p>
        </div>
        ...
        <p
          ...
          @click="like(comment)"
        >
          {{ comment.likedCount | formatCommentNum }}
          <i class="iconfont icon-iclikenormal" />
        </p>
      </header>
      <div class="content" v-html="formatContent(comment.content)" />
    </div>
  </div>
</template>
