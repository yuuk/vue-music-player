...
<template>
  <div class="progress-bar" ref="progressBar" @click="progressClick">
    <div class="progress-bar-inner">
      ...
      <p class="progress-bar-line" ref="progress" />
      <p class="progress-bar-buffer" :style="{ width: `${buffer}%` }" />
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.progressBtnWidth = this.$refs.progressBtn.querySelector(
      '.progress-bar-ball'
    ).clientWidth;
  },
  methods: {
